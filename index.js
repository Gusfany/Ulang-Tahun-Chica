document.addEventListener('DOMContentLoaded', () => {
  ...
  const typingConfig = {
    lines: [
      "Being with you is something I never imagined before, you always fill my day i can't imagine life without you.",
      "On our special day, I just want you to know how much you mean to me and how grateful i am .",
      "You deserve all the joy in the world, if i love you for 3 days, that i mean yesterday, today, and forever."
    ],
